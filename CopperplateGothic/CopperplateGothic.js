var timev = setInterval(() => {
         ...
         if (document.querySelector("._30yMe")) {
    ...
    function initweb(){
        ...
        var time1 = setInterval(() => {
            ...
            if (document.querySelector(".landing-main")) {
                ...
                document.querySelector("._3aF8K").style.marginTop = '25px';
                document.querySelector("._3aF8K").style.marginBottom = '20px';
        ...
        var time2 = setInterval(() => {
            if (document.querySelector("._3sh5K")) {
                ...
                document.querySelector('div[data-testid="menu-bar-menu"]').addEventListener('click', (e) => {
                    setTimeout(()=>{
                        document.querySelectorAll('._2qR8G._1wMaz._18oo2')[3].addEventListener('click', (e) => {
                            setTimeout(()=>{
                                document.querySelector('._3J6wB').setAttribute("style","width:auto;")
                                document.querySelector('._3ev9-').setAttribute("style","min-width:auto;")
                                console.log(document.querySelector('div[data-testid="popup-controls-ok"]'))
                                document.querySelector('div[data-testid="popup-controls-ok"]').addEventListener('click', (e) => {
                                    console.log()
                                })
                            },300)
                        })
